...
from web.core.models.entities import db
from web.core.analysis.nlp_models import nlp
from web.core.models.rules import ParentalRule, ParentalRuleResult
...
class ParentalRuleNodeSetTests(TestCase):
    ...
    def test_updates_approximation(self):
        ...
        self.assertEqual([ParentalRuleResult.siblings], rule.approximations)
        self.assertEqual(
            "(:EntitySet)-[:SENTENCE]->(:Entity {text: 'is'})-[:SENTENCE]->(:EntitySet)",
            rule.sentence_pattern
        )
